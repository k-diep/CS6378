...
public class NodeTimestamp implements Comparable<NodeTimestamp>{
    ...
    public static void main(String[]args){
        ...
        ArrayList<NodeTimestamp> nodeTimestampList = new ArrayList<NodeTimestamp>();
        ...
        pq.add(node2);
        pq.add(node1);
        nodeTimestampList.add(node1);
        nodeTimestampList.add(node2);
        System.out.println(pq);

        for (NodeTimestamp nt : nodeTimestampList){
            if (nt.getValue() == 1){
                pq.remove(nt);
            }
        }
