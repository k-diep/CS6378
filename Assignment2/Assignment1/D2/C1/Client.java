...
public class Client {
    ...
    public static void main(String[] args) throws IOException{
        ...
        Socket socket0 = new Socket("10.176.69.32", 1230); //DC01.utdallas.edu
        Socket socket1 = new Socket("10.176.69.33", 1231); //DC02.utdallas.edu
        Socket socket2 = new Socket("10.176.69.34", 1232); //DC03.utdallas.edu
        Socket socket3 = new Socket("10.176.69.35", 1233); //DC04.utdallas.edu
        Socket socket4 = new Socket("10.176.69.36", 1234); //DC05.utdallas.edu
        Socket socket5 = new Socket("10.176.69.37", 1235); //DC06.utdallas.edu
        Socket socket6 = new Socket("10.176.69.38", 1236); //DC07.utdallas.edu
        Socket socket7 = new Socket("10.176.69.39", 1237); //DC08.utdallas.edu
